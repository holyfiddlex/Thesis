...
\par
Data wrangling consists of is making sure that the data has a specific format. *** % Link to appendix and reference
...
Sometimes, the length of the times series isn't what our model was expecting.
...
\subsection{Phase}
\qquad \section{Feature extraction}
In machine learning, feature extraction is the process of representing data in a more "understandable" way.
